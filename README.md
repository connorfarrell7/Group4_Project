...
We will use PostgresSQL to host the data from the tables containing students’ demographic information (ID, Age, Gender, Stream) [link reference] and the parameters used to predict the probability of obtaining an engineering placement (ID, CGPA, Past Internships, Hostel Stay, History of Backlogs) [link reference]. Using the ERD [College_Placement_ERD.png]( https://github.com/connorfarrell7/Predicting_Placements_for_Engineering_Students/blob/main/Deliverable%202%20-%20Database%20Files/College_Placement_ERD.png) and SQL code [link reference], we will join these tables and export the data as a csv file ([collegePlace.csv](https://github.com/connorfarrell7/Predicting_Placements_for_Engineering_Students/blob/main/collegePlace.csv)). 
